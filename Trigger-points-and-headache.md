...
筋膜性トリガーポイント（MTrP）は、骨格筋の中にある**過敏化したスポット**で、触れると索状に硬くなった帯（taut band）の中に、押すと痛む結節（hypersensitive palpable nodule）として触知されると定義されています<cite index="38-1">筋膜性トリガーポイントは、索状の帯の中にある過敏で触知可能な結節を伴う骨格筋内の過敏なスポットとして定義される</cite>。この概念は1950年代にTravellとSimonsによって広められました<cite index="38-1">筋膜性トリガーポイントという用語は1950年代に広まった</cite>。

MTrPには大きく2種類があります。

| 種類 | 特徴 |
|---|---|
| **活動性（active）トリガーポイント** | 何もしなくても持続的な痛みを引き起こす<cite index="38-1">活動性のトリガーポイントは持続的な痛みの訴えを生じさせる</cite> |
| **潜在性（latent）トリガーポイント** | 押す（触診・圧迫）ことでのみ痛みが生じる<cite index="38-1">潜在性のトリガーポイントは用手的な触診の際にのみ痛みを生じる</cite> |

重要なポイントとして、MTrPの存在やその評価方法には**科学的な論争が現在も続いています**。ICHD-3自体も「いわゆる“トリガーポイント”と筋膜性疼痛の関係には議論があり、再現性をもって示すことが難しく、治療反応にもばらつきがある」と明記しています<cite index="2-1">筋膜性疼痛といわゆる「トリガーポイント」との関係は議論の的であり、想定されるトリガーポイントを一貫して示すことは困難であり、治療への反応も様々である</cite>。この点は本ガイド全体を通じて念頭に置いてください。
...
ICHD-3では、緊張型頭痛は**頭蓋周囲の圧痛（pericranial tenderness）の有無**によってさらにサブタイプ分類されています。この圧痛は用手的な触診で評価され、頭痛の強さや頻度が増すほど圧痛も強くなる傾向があるとされます<cite index="31-1">頭蓋周囲の圧痛は、緊張型頭痛のいずれのタイプでも最も重要な異常所見であり、通常発作間欠期にも存在し、実際の頭痛時に増悪し、頭痛の強さと頻度の増加とともに増大する</cite>。この圧痛は簡便に触診で検出・記録できるとされています<cite index="31-1">頭蓋周囲の圧痛は用手的な触診によって容易に検出・記録できる</cite>。

### 2-2. 頸原性頭痛（Cervicogenic Headache）

頸椎やその周囲軟部組織の障害によって生じる頭痛です<cite index="27-1">頸原性頭痛は、頸椎およびその骨・椎間板・軟部組織の障害によって引き起こされる頭痛であり、通常は（必ずではないが）頸部痛を伴う</cite>。診断には、頭痛が頸部の障害と時間的に関連して発症・改善すること、頸部可動域の低下や誘発手技での増悪、診断的ブロックでの消失といった**因果関係の証拠**が求められます<cite index="27-1">頭痛が頸部障害の発症と時間的に関連して発現したこと、頸部の障害や病変の改善と並行して頭痛が有意に改善または消失したこと、頸部の可動域が低下しており誘発手技によって頭痛が有意に増悪すること、頸部構造またはその神経支配への診断的ブロックによって頭痛が消失することのうち、少なくとも2つによって因果関係の証拠が示されること</cite>。

### 2-3. 付録診断：頸部筋膜性疼痛による頭痛（A11.2.5）

ICHD-3の付録には、「頸部の筋肉における筋膜性疼痛（トリガーポイントを含む）が原因である」ことを示す診断基準が試験的に収載されています<cite index="2-1">頸部筋肉における筋膜性疼痛の原因、再現可能なトリガーポイントを含むものが示されていること</cite>。ただし、これは**さらなるエビデンスの蓄積を待つ研究段階の診断**であり、正式な診断カテゴリーではありません<cite index="27-1">A11.2.5 頸部筋膜性疼痛による頭痛は、この種の頭痛が緊張型頭痛よりも他の頸原性頭痛に近いという証拠を待つ付録診断である</cite>。

---

## Step 3. 病態メカニズム：なぜトリガーポイントと頭痛が関連しうるのか

トリガーポイントと頭痛の関係については、大きく2つの仮説モデルが議論されています<cite index="38-1">ボトムアップモデルは、末梢の侵害受容伝達の増加が中枢神経系を感作させ痛みの知覚閾値を下げるとするのに対し、トップダウンモデルはこれらの変化がすでに中枢神経系に存在しているとする</cite>。
...
緊張型頭痛においては、活動性トリガーポイントを押すと、患者が普段感じている頭痛パターンが再現されることが複数の研究で示されています<cite index="38-1">緊張型頭痛患者において、活動性トリガーポイントによって誘発される関連痛が頭痛パターンを再現することが研究で示されている</cite>。また、活動性トリガーポイントを持つ患者は、より広範囲の痛覚過敏（圧痛閾値の低下）を示すことがあり、これは中枢感作への関与を示唆すると考えられています<cite index="4-1">緊張型頭痛患者の頭蓋周囲筋における活動性筋膜トリガーポイントは、全身的な圧痛閾値の低下と相関しており、中枢感作への関与を示唆する</cite>。

一方で片頭痛については、活動性トリガーポイントの触診が片頭痛発作を誘発しうることが報告されていますが<cite index="3-1">活動性の筋膜トリガーポイントは片頭痛患者に多くみられ、用手的な触診が片頭痛発作を誘発することがある</cite>、トリガーポイントの数が発作頻度や強度と関連するかについては研究間で結果が一致していません<cite index="3-1">これらの知見はボトムアップの因果関係を示唆する可能性があるが、線維筋痛症を合併する片頭痛患者の研究はそれとは異なる結果を示している</cite>。

> **ポイント**：トリガーポイントは頭痛の「原因」なのか「結果（二次的な蓄積）」なのかは、現時点の国際的なエビデンスでも**結論が出ていません**<cite index="4-1">思春期に比べ成人で活動性の筋膜トリガーポイントの数が多いことは、頭痛パラメーターとの有意な関連がないにもかかわらず、トリガーポイントが緊張型頭痛の病態に寄与するというよりも、時間経過とともに蓄積した結果である可能性を示唆する</cite>。
...
これらの知見は、いずれも触診・関連痛誘発試験を用いた臨床研究に基づくものであり<cite index="38-1">緊張型頭痛（TTH）と筋膜トリガーポイントに関する研究への関心が高まっている</cite>、**画像診断によって客観的に「見える」ものではない**ことに注意が必要です。トリガーポイントの検出は現在も主に用手触診に依存しており、施術者間で一致率が低いという再現性の課題が指摘されています<cite index="38-1">この技術は再現性に乏しいことが判明しており、異なる患者群を盲検下で検査した際に施術者間でトリガーポイントの位置について意見が一致しない</cite>。超音波エラストグラフィーなど新しい画像評価法も研究段階にあります<cite index="38-1">超音波エラストグラフィーは筋膜トリガーポイントを評価する最も有望なツールである</cite>。
...
国際的に使われる二次性頭痛のスクリーニングリスト **SNNOOP10** は、以下のような項目に当てはまる場合、単なる一次性頭痛ではない可能性を考慮すべきとしています<cite index="50-1">全身症状（発熱を含む）、腫瘍の既往、神経学的異常（意識レベル低下を含む）、突然の急な発症、高齢（65歳以降の発症）、頭痛パターンの変化や新規発症、体位による頭痛、くしゃみ・咳・運動により誘発される頭痛、乳頭浮腫、進行性の頭痛や非典型的な臨床像、妊娠または産褥期、自律神経症状を伴う眼の痛み、外傷後の頭痛発症、免疫系の病理（HIVなど）、鎮痛薬の使用過多や新規薬剤の使用開始</cite>。
...
| トリガーポイントを対象とした徒手療法（虚血性圧迫・ポジショナルリリース・マッサージ等） | 緊張型頭痛・片頭痛 | **bC**（限定的） | メタ解析で発作頻度・強度・持続時間の統計的に有意な減少が示されたが、全体のエビデンスの質は非常に低いと評価<cite index="16-1">併用結果はコントロール群と比較して治療後のすべてのアウトカムで統計的に有意な減少を示したが、エビデンスの水準は非常に低かった</cite> |
| ドライニードリング | 緊張型頭痛 | **bB/bC**（中等度〜限定的） | 複数のRCTで活動性トリガーポイント数と頭痛強度の減少が報告 |
| 鍼治療（acupuncture） | 月15日以上の頻回な緊張型頭痛 | **bB**（NICEが選択肢として言及） | 英国NICEガイドラインでは、頻回な緊張型頭痛に対して最大10回程度の鍼治療のコースが選択肢として挙げられている<cite index="23-1">緊張型頭痛が月15日以上ある場合、今後の緊張型頭痛を予防するために最大10回の鍼治療のコースが提案されることがある</cite> |
...
一般に、医療専門家が行う施術としては**用手療法（マニュアルセラピー）系のアプローチ**が比較的研究の蓄積があり、頸原性頭痛に対しては中等度のエビデンスが示されています。緊張型頭痛・片頭痛に対するトリガーポイント指向の徒手療法は、有望な結果を示す研究がある一方、プラセボ対照が不十分な試験が多く、**総合的なエビデンスの質は依然として低い**と評価されています<cite index="16-1">筋膜トリガーポイントの治療は侵襲的方法（ドライまたはウェットニードリング）または非侵襲的方法で行われる</cite>。
...
頭痛の診断・治療方針の決定は、問診と身体診察が最も重要であるとされ<cite index="53-1">頭痛診断において最も重要な点は病歴聴取と身体診察である</cite>、一次性頭痛は除外診断ではなく支持的な臨床所見に基づいて診断されるべきものとされています<cite index="53-1">一次性頭痛は除外による診断ではなく、支持的な臨床所見に基づくものである</cite>。
