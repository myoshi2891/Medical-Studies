...
import { HeadacheRelatedNervesSidebar } from "./HeadacheRelatedNervesSidebar";

/**
 * HeadacheRelatedNervesSidebar の scroll-spy 契約テスト。
 *
...
describe("HeadacheRelatedNervesSidebar", () => {
  beforeEach(() => {
