...
const NAV_ITEMS: readonly NavItem[] = [
  ...
  { id: "s5", num: "5", label: "診断基準 Step-by-Step" },
  { id: "s6", num: "6", label: "SNOOP4 スクリーニング" },
  { id: "s7", num: "7", label: "鑑別診断" },
  { id: "s8", num: "8", label: "評価ツール・スコアリング" },
  { id: "s9", num: "9", label: "治療戦略" },
  { id: "s10", num: "10", label: "栄養補助療法" },
  { id: "s11", num: "11", label: "MOH リスク評価" },
  { id: "s12", num: "12", label: "特殊集団への対応" },
  { id: "s13", num: "13", label: "標準化ケーススタディ" },
  { id: "s14", num: "14", label: "エビデンス階層サマリー" },
  { id: "s15", num: "15", label: "参考文献・リソース" },
];

/**
  * 緊張型頭痛（TTH）ガイドの固定サイドバー目次。
  *
