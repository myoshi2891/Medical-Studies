            ...
            <section className="sec" id="s6">
              ...
              <div className="card">
                ...
                <div className="alert a-ok">
                  <span className="alert-i">🇯🇵</span>
                  <div>
                    <strong>臨床的意義：</strong>HIT-6 は日本語版が正式に検証されており（Sakai et
                    al. 2004）、Eli Lilly Japan
            ...
            <section className="sec" id="s8">
              ...
              <div className="card">
                ...
                <div className="alert a-info">
                  <span className="alert-i">📊</span>
                  <div>
                    <strong>疾患重症度の鑑別指標として：</strong>
                    片頭痛患者（発作性・慢性）は典型的に 60点以上を示すのに対し、非片頭痛頭痛では
                    50点を下回る傾向があります（Yang et al. 2011, <em>n</em> = 2,049）。ただし HIT-6
                  ...
                  <table>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          質問の理解・記憶への影響を考慮。補助者によるサポートが必要な場合あり
                        </td>
                      </tr>
                      <tr>
                        <td>
              ...
              <div className="card">
                ...
                <div className="src-grid">
                  <div className="src">
                    ...
                    <div className="src-t">
                      Kosinski M, et al. — A six-item short-form survey for measuring headache
                      impact: The HIT-6™
                    </div>
                    <div>
                      <em>Qual Life Res</em> 2003;12(8):963–974
                  ...
                  <div className="src">
                    ...
                    <div className="src-t">
                      Martin M, et al. — The short-form HIT-6 was psychometrically equivalent in
                      nine languages
                    </div>
                    <div>
              ...
              <div className="card">
                ...
                <div className="src-grid">
                  ...
                  <div className="src">
                    ...
                    <div className="src-t">
                      Houts CR, et al. — Content validity of HIT-6 as a measure of headache impact
              ...
              <div className="card">
                ...
                <div className="src-grid">
                  ...
                  <div className="src">
                    ...
                    <div className="src-t">
                      Houts CR, et al. — Determining Thresholds for Meaningful Change for the HIT-6
                      in Chronic Migraine
                    </div>
                    <div>
