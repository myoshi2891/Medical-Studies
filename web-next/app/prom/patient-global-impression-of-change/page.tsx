          ...
          <section id="s3" className="sec">
            ...
            <div className="card">
              ...
              <div className="alert a-ok">
                <span className="alert-i">⭐</span>
                <div>
                  <strong>臨床的解釈の閾値：スコア 5〜7 = 有意な改善（favorable response）</strong>
                  <br />
...
style B3 fill:#c8e6c9,stroke:#2e7d32`}
          ...
          <section id="s6" className="sec">
            ...
            <div className="card">
              <h3>6.1 MCIDとは何か</h3>
              <p>
                <strong>MCID（Minimal Clinically Important Difference / 最小臨床的重要差）</strong>{" "}
            ...
            <div className="card">
              ...
              <div className="mmd">
                <div className="mmd-lbl">フローチャート — PGICアンカーベースのMCID算出プロセス</div>
                <MermaidDiagram
                  themeVariables={PGIC_MERMAID_THEME}
                  chart={`flowchart TD
                ...
                <table>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <strong>−2.3点</strong>（MCID）；<strong>−6点</strong>以上が「実質的な改善」
                      </td>
                      <td>PGIC 5〜7</td>
...
Month 12 最終評価（全転帰指標） :crit, a6, 2024-12, 14d`}
            ...
            <div className="card">
              ...
              <div className="alert a-ok">
                <span className="alert-i">✅</span>
                <div>
                  <strong>★ スコア5〜7 = 治療有効応答（clinically meaningful improvement）</strong>
                </div>
              </div>
            </div>
...
style C fill:#ffcdd2,stroke:#c62828`}
          ...
          <section id="s8" className="sec">
            ...
            <div className="card">
              ...
              <p>
                ...
                eptinezumab）の臨床試験では、PGIC は<strong>副次転帰（secondary endpoint）</strong>
                として一貫して採用されています。
              </p>
            </div>
            ...
            <div className="card">
              ...
              <ul>
                ...
                <li>
                  治療中断の 21.3% は「無効」を理由とするものでしたが、MMD削減が基準を満たしていても
          ...
          <section id="s9" className="sec">
            ...
            <div className="card">
              ...
              <ul>
                ...
                <li>臨床医が観察できない領域（家庭内活動、睡眠の質等）を患者だけが評価している</li>
              </ul>
            </div>
          </section>
          ...
          <section id="s11" className="sec">
            ...
            <div className="card">
              ...
              <div className="mmd">
                <div className="mmd-lbl">フローチャート — 複数転帰指標による多角的治療効果評価</div>
                <MermaidDiagram
                  themeVariables={PGIC_MERMAID_THEME}
                  chart={`graph TD
            ...
            <div className="card">
              ...
              <div className="src-grid">
                <div className="src">
                  ...
                  <div className="src-t">
                    Patient global impression of change scores within the context of a chronic pain
