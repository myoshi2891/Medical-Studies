      ...
      <div className="layout">
        ...
        <main className="main">
          ...
          <section id="s1" className="sec">
            ...
            <p>
              疼痛（Pain）は、
              <strong>国際疼痛学会（IASP: International Association for the Study of Pain）</strong>{" "}
...
style A fill:#e3f2fd,stroke:#1565C0`}
          ...
          <section id="s2" className="sec">
            ...
            <p>
              疼痛評価への VAS の体系的導入は、英国のリウマチ科医 <strong>E.C. Huskisson</strong> が
              1974 年 <em>The Lancet</em> に発表した論文に端を発します。この論文で Huskisson
              は、当時の疼痛測定法と比較して VAS が<strong>最も感度の高い（most sensitive）</strong>
              疼痛測定法であると結論づけました。
            </p>
            <div className="alert a-info">
              <div className="alert-i">📚</div>
          ...
          <section id="s3" className="sec">
            ...
            <div className="alert a-warn">
              ...
              <div>
                <strong>重要：</strong>
                中間に目盛りや数字を加えると連続スケールの特性が失われ、事実上 NRS に変容します。IHS
                ガイドラインに準拠した研究では、<strong>数字・目盛りなしの 100mm 線</strong>
                のみを使用してください。
              </div>
            </div>
...
style H fill:#c8e6c9,stroke:#1B5E20`}
            ...
            <div className="alert a-info">
              ...
              <div>
                ...
                の急性期試験ガイドラインの基準です。4 段階 VRS（0〜3）との対応は「軽度（NRS 1〜3）=
                VRS 1、中等度（NRS 4〜6）= VRS 2、重度（NRS 7〜10）= VRS 3」と近似されます。
              </div>
            </div>
          ...
          <section id="s6" className="sec">
            ...
            <div className="card">
              <ul>
                <li>初期トリプタン試験（1990 年代）が確立した 4 段階 VRS の伝統とその利点・限界</li>
                <li>
            ...
            <div className="mmd">
              <div className="mmd-lbl">フローチャート — 評価設定・患者特性に応じたスケール選択</div>
              <MermaidDiagram
                themeVariables={VNS_MERMAID_THEME}
                chart={`graph TD
...
style K fill:#e8f5e9,stroke:#2E7D32`}
          ...
          <section id="s8" className="sec">
            ...
            <div className="mmd">
              <div className="mmd-lbl">フローチャート — 統計的有意差と臨床的意義（MCID）の関係</div>
              <MermaidDiagram
                themeVariables={VNS_MERMAID_THEME}
                chart={`flowchart LR
...
style P fill:#ffcdd2,stroke:#C62828`}
          ...
          <section id="s11" className="sec">
            ...
            <div className="alert a-warn">
              <div className="alert-i">⚠️</div>
              <div>
                <strong>重要エビデンス：</strong>Rognstad et al. (2023) の前向き研究（平均 77 歳・37
                名）では、VAS と NRS の間に平均 2.0 点（95% LoA:
          ...
          <section id="s15" className="sec">
            ...
            <div className="src-grid">
              <div className="src">
                ...
                <div className="src-t">Huskisson EC. Measurement of pain — VAS 臨床導入の原典</div>
              ...
              <div className="src">
                ...
                <div className="src-t">
                  Jensen MP, et al. The measurement of clinical pain intensity: a comparison of six
                  methods
                </div>
                <div className="src-url">
              ...
              <div className="src">
                ...
                <div className="src-t">
                  Salaffi F, et al. Minimal clinically important changes in chronic musculoskeletal
                  pain (NRS) — MCID 1.74 点
                </div>
                <div className="src-url">
            ...
            <div className="src-grid">
              <div className="src">
                ...
                <div className="src-t">
                  Loder E, Burch R. Measuring pain intensity in headache trials: which scale to use?
                </div>
                <div className="src-url">
