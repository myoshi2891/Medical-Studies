...
import NumericalRatingScaleVisualAnalogueScalePage from "./page";
...
const EXTERNAL_LINK_COUNT = 20; // 外部リンク数

describe("NumericalRatingScaleVisualAnalogueScalePage: 契約（忠実転記）", () => {
 ...
 */
describe("NumericalRatingScaleVisualAnalogueScalePage: 関連ページ導線", () => {
  const HREF = "/prom/numerical-rating-scale-visual-analogue-scale";
