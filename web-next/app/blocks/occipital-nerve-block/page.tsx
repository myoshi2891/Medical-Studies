            ...
            <section id="s1" className="sec">
              ...
              <div className="alert a-info">
                ...
                <div>
                  ...
                  <strong>「中枢感作の抑制」</strong>が起きているためと考えられています（§3
                  で詳述）。
                </div>
              </div>
            </section>
...
style F fill:#2e7d32,color:#fff`}
              ...
              <div className="onb-role-grid">
                <div className="onb-role">
                  ...
                  <div className="onb-role-d">
                    ...
                    （EOPから約1/3）。<strong>後頭動脈の拍動の内側</strong>。上項線レベル。目安は
                    EOP から
              ...
              <div className="alert a-info">
                ...
                <div>
                  ...
                  <strong>三叉頸椎複合体（TCC）</strong>
                  に入り、三叉神経第1枝（V1）からの求心性線維と
...
style F fill:#1b5e20,color:#fff`}
              ...
              <div className="alert a-info">
                ...
                <div>
                  ...
                  within the trigeminocervical complex. <em>J Neurol Neurosurg Psychiatry</em>,
                  2021. doi:
            ...
            <section id="s4" className="sec">
              ...
              <div className="mmd">
                <div className="mmd-lbl">
                  フローチャート — SNOOP4 による二次性頭痛スクリーニング
                </div>
                <MermaidDiagram
                  themeVariables={ONB_MERMAID_THEME}
                  chart={`flowchart TD
...
style E2 fill:#e8f5e9,stroke:#2e7d32`}
              ...
              <div className="alert a-info">
                ...
                <div>
                  ...
                  occipital nerve block for the treatment of cluster headache: a systematic review
                  and meta-analysis." <em>Cephalalgia</em> 2020. PMID:{" "}
            ...
            <section id="s16" className="sec">
              ...
              <div className="src-grid">
                ...
                <div className="src">
                  ...
                  <div className="src-t">
                    Lambru G et al. — トリアムシノロンによる脱毛・皮膚萎縮
                  </div>
                  <Ext
            ...
            <section id="s17" className="sec">
              ...
              <div className="onb-key-grid">
                ...
                <div className="onb-key">
                  ...
                  <div className="onb-key-tx">
                    片頭痛ではステロイド追加の上乗せ効果はない。
                    <strong>群発頭痛・後頭神経痛</strong>
                    では追加推奨。
                  </div>
                </div>
                <div className="onb-key">
