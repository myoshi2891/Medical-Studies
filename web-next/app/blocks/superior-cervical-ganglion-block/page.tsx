    ...
    <div className="superior-cervical-ganglion-block">
      ...
      LC --> TP["頸椎横突起\\n（C2–C3）"]`}
            ...
            <section id="s3" className="sec">
              ...
              <div className="card">
                <p>
                  ...
                  <strong>頭部・顔面に及ぼす影響がより明確</strong>であるとされています
                  <sup>[4]</sup>
            ...
            <section id="s6" className="sec">
              ...
              <div className="card">
                <p>
                  現在、国際文献で報告されている主流の手法は
                  <strong>超音波ガイド下アプローチ</strong>
            ...
            <section id="s7" className="sec">
              ...
              <div className="card">
                <p>
                  ...
                  <strong>経口法（transoral approach）</strong>
                  が古典的な手技として報告されていました
                  <sup>[2][4]</sup>
              ...
              <div className="src-grid">
                ...
                <div className="src">
                  ...
                  <div className="src-t">
                    ...
                    Superior Cervical Ganglion, Description of a Novel Ultrasound-Guided Technique
                    in Human Cadavers.
                  </div>
                  <div className="src-url">
                ...
                <div className="src">
                  ...
                  <div className="src-t">
                    ...
                    Complications associated with stellate ganglion nerve block: a systematic
                    review.
                  </div>
                  <div className="src-url">
