...
import CervicalPlexusBlockPage from "./page";
...
/** ソース HTML（Cervical-Plexus-Block.html）から実測した忠実転記の契約値。 */
const SECTION_IDS = Array.from({ length: 18 }, (_, i) => `s${i + 1}`);
const H2_COUNT = 38;
const MERMAID_COUNT = 12;
const TABLE_COUNT = 22;
const NAV_COUNT = 18;
const HERO_H1 = "浅・深頚神経叢ブロック（Cervical Plexus Block: CPB）完全ガイド";

describe("CervicalPlexusBlockPage: 契約（忠実転記）", () => {
 ...
 */
describe("CervicalPlexusBlockPage: 関連ページ導線", () => {
  const HREF = "/blocks/cervical-plexus-block";
