            ...
            <div className="tbl">
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    <td>1920年</td>
                    <td>Victor Pauchet が外側アプローチを推奨（後方アプローチより優れると主張）</td>
                  </tr>
                  <tr>
                    <td>1975年</td>
...
style TARGET fill:#1b5e20,color:#fff`}
          ...
          <section id="s10" className="sec">
            ...
            <h2>10-1. 概要と位置づけ</h2>
            <p>
              中間CPB は、2004年に導入された比較的新しいアプローチです。浅CPB より効果が強く、深CPB
            ...
            <div className="tbl">
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    <td>3. C4レベルの確認</td>
                    <td>C4横突起は前結節のみ（後結節なし）が特徴。これを指標に椎体レベルを確認</td>
                  </tr>
                  <tr>
                    <td>4. 針の刺入</td>
                    <td>
...
style CHOICE fill:#1565c0,color:#fff`}
            ...
            <div className="alert a-info">
              ...
              <div>
                ...
                を支持する初の大規模RCT証拠です。　<span className="bA">Grade A</span>（2025年更新）
              </div>
            </div>
          ...
          <section id="s17" className="sec">
            ...
            <div className="src-grid">
              ...
              <div className="src">
                ...
                <div className="src-t">
                  Pandit JJ et al. (2007) — Superficial or deep CPB for CEA: a systematic review of
                  complications（BJA 99:159-169）
                </div>
                <div className="src-url">
              ...
              <div className="src">
                ...
                <div className="src-t">
                  Wilson L et al. (2023) — Analgesic effects of bilateral superficial CPB in thyroid
                  surgery: SR/MA（67:579-89）
                </div>
                <div className="src-url">
              ...
              <div className="src">
                ...
                <div className="src-t">
                  Turhan Ö et al. (2025) — US-guided intermediate vs deep CPB for CEA: RCT（25:581）
                </div>
                <div className="src-url">
