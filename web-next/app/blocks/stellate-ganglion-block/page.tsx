            ...
            <div className="tbl">
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    <td>2020年代</td>
                    <td>不整脈（電気的嵐）・周術期合併症予防など新領域へのエビデンス蓄積が進む</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <section id="s4" className="sec">
            ...
            <div className="alert a-info">
              ...
              <div>
                ...
                <span className="bA">Grade A</span> = 複数の高質なRCTまたはCochrane系統的レビュー／
          ...
          <section id="s11" className="sec">
            ...
            <div className="src-grid">
              <div className="src">
                ...
                <Ext href="https://emcrit.org/emcrit/stellate-ganglion-block/" className="src-url">
