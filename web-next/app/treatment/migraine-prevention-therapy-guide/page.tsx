    ...
    <div className="migraine-prevention">
        ...
        <main className="main">
          <AutoGlossary>
            ...
            <div className="alert a-warn" id="overview-notice">
              ...
              <div>
                <strong>
                  本ページは教育目的の一般情報整理です。個別の治療推奨ではありません。
                </strong>
                <br />
      ...
      AD --> AD1[アミトリプチリン・ベンラファキシン]`}
              ...
              <div className="alert a-info">
                <div className="alert-i">📖</div>
                <div>
                  出典：AAN/AHS「Evidence-based guideline update: Pharmacologic treatment for
                  episodic migraine prevention in adults」（Neurology, 2012）{" "}
                ...
                <table>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>フルナリジン（Ca拮抗薬）</td>
                      <td>
                        プラセボと比較した有効性が示されているが、日本を含む一部地域では未承認
                      </td>
                    </tr>
                    <tr>
                      <td>Part 3</td>
