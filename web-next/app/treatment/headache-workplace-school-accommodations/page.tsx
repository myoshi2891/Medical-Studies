          ...
          <AutoGlossary>
            ...
            <section id="s1" className="sec">
              ...
              <div className="alert a-warn">
                ...
                <div>
                  <strong>
                    本ページは教育目的であり、個別の治療推奨・法律相談ではありません。
                  </strong>
            ...
            <section id="s3" className="sec">
              ...
              <div className="card">
                <ul style={{ fontSize: 13.5 }}>
                  ...
                  <li>
                    提供する側（雇用主・学校）にとって「過重な負担（undue hardship /
                    disproportionate burden）」とならない範囲であること
                  </li>
                  <li>
            ...
            <section id="s8" className="sec">
              ...
              <div className="src-grid">
                ...
                <div className="src">
                  ...
                  <div className="src-t">
                    Begasse de Dhaem O, et al. Identification of work accommodations and
                    interventions associated with work productivity in adults with migraine.
                    Cephalalgia. 2021
                  </div>
                  <Ext
                ...
                <div className="src">
                  ...
                  <div className="src-t">
                    ...
                    headache education and clinical evaluation program in the workplace.
                    Cephalalgia. 2023
                  </div>
                  <Ext
                ...
                <div className="src">
                  ...
                  <div className="src-t">
                    U.S. Department of Education, Office for Civil Rights. Section 504 Protections
                    for Students with Migraine
                  </div>
                  <Ext
                ...
                <div className="src">
                  <div className="src-org">一次文献</div>
                  <div className="src-t">
                    Igarashi H, et al. Underrecognition of migraine-related stigmatizing attitudes
                    and social burden: OVERCOME Japan study. Brain and Behavior. 2024
                  </div>
                  <Ext
