    ...
    <div className="lifestyle-seeds-accent">
      ...
      E2 -.->|本ページで詳説| Focus`}
            ...
            <section id="s6" className="sec">
                ...
                <table className="th-teal">
                  ...
                  <tbody>
                    <tr>
                      <td>頭痛の性質</td>
                      <td>
                        拡散性（部位がはっきりしない）で、非拍動性、軽度〜中等度の強さが典型的
                      </td>
                    </tr>
                    <tr>
                      <td>発症条件</td>
              ...
              <ul>
                <li>
                  1日のうちで食事の間隔が極端に空きすぎないよう、
                  <strong>規則正しい食事リズム</strong>
                ...
                <table>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>Diary（頭痛日記）</td>
                      <td>
                        発作の頻度・誘因・治療反応を記録し、診断精度や治療効果の評価に役立てる
                      </td>
                      <td>
            ...
            <section id="s10" className="sec">
              ...
              <div className="src-grid">
                ...
                <div className="src">
                  ...
                  <div className="src-t">
                    Spigt M, et al. &quot;A randomized trial on the effects of regular water intake
                    in patients with recurrent headaches.&quot; Fam Pract. 2012;29(4):370-375.
                  </div>
                  <div className="src-url">
                ...
                <div className="src">
                  ...
                  <div className="src-t">
                    &quot;Primary headache disorders susceptibility is associated with
                    fasting-related headache&quot; (Frontiers in Neurology)
                  </div>
                  <div className="src-url">
