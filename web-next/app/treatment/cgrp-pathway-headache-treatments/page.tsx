      ...
      C --> C4["zavegepant ザベゲパント\\n(点鼻・急性期のみ・国内未承認)"]`}
            ...
            <section id="s7" className="sec">
              ...
              <div className="alert a-info">
                <div className="alert-i">ℹ️</div>
                <div>
                  出典：Puledda et al., International Headache Society Global Practice
                  Recommendations for Preventive Pharmacological Treatment of Migraine, Cephalalgia
                  2024 —{" "}
          ...
          J3 --> J4["CGRP関連抗体薬／ゲパントの導入を検討"]
            ...
            <section id="s9" className="sec">
              ...
              <div className="alert a-info">
                <div className="alert-i">📌</div>
                <div>
                  これらのバッジは各エビデンスが得られた研究デザインの
                  <strong>層（カテゴリ）</strong>
            ...
            <section id="s14" className="sec">
              ...
              <div className="src-grid">
                ...
                <div className="src">
                  <div className="src-org">Systematic Review</div>
                  <div className="src-t">
                    Efficacy and Safety of Anti-CGRP Monoclonal Antibodies in Preventing Migraines:
                    A Systematic Review
                  </div>
                  <div className="src-url">
                ...
                <div className="src">
                  ...
                  <div className="src-t">
                    A Real-World Study of CGRP Monoclonal Antibodies for
                    Migraine（日本国内コホート）
                  </div>
                  <div className="src-url">
                    <Ext href="https://onlinelibrary.wiley.com/doi/10.1111/ene.70562">
