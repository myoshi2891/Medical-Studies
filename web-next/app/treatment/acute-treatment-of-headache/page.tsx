        ...
        <main className="main">
          <AutoGlossary>
            ...
            <section id="s1" className="sec">
              ...
              <div className="card">
                <p>
                  本ページは、頭痛（主に片頭痛）の<strong>急性期治療</strong>
                  （発作が起きたときの治療）について、
                ...
                <p>
                  あわせて、<strong>階層化治療（stratified care）</strong>と
                  <strong>早期服薬の原則</strong>
                  という2つの重要な治療戦略の考え方、および
                  <strong>薬剤の使用過多による頭痛（MOH: Medication-Overuse Headache）</strong>
                  の予防についても解説します。
                </p>
                <p>
              ...
              <div className="alert a-info">
                ...
                <div>
                  <strong>一般名の使用について</strong>
                  ：本資料では医薬品を一般名（成分名）または薬効群名で記載することを原則とし、
              ...
              <div className="card">
                <p>
                  <span className="bA">A：質の高いエビデンス</span>
                  　システマティックレビュー・複数のRCTで一貫した結果
                  <br />
                  <br />
                  <span className="bB">B：中等度のエビデンス</span>
                  　良質なRCTがあるが限定的、または結果に一部不一致
                  <br />
                  <br />
                  <span className="bC">C：限定的なエビデンス</span>
                  　小規模試験・観察研究が中心、確実性は高くない
                  <br />
                  <br />
                  <span className="bU">U：未確立／今後の検証課題</span>
                  　実臨床データの蓄積中、長期的な結論は未確定
                </p>
              </div>
            </section>
            ...
            <section id="s2" className="sec">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        ...
                        効果が不十分な場合に、発作の中で（within
                        attack）あるいは複数回の発作を経て（across attacks）、
              ...
              <p>
                この2つの戦略を比較した代表的な研究が、Lipton らによる
                <strong>DISC試験（Disability in Strategies of Care Study）</strong>
                です（<em>JAMA</em>,
                2000）。13か国・88施設が参加したこの無作為化比較試験では、階層化治療が段階的治療と比較して、
              ...
              <div className="alert a-info">
                <div className="alert-i">🌍</div>
                <div>
                  その後、欧州頭痛連合（EHF）の実践的な立場（Eigenbrodtら, <em>Nat Rev Neurol</em>,
                  2021 等）では、
  ...
  I -->|中等度から重度| K["片頭痛特異的治療を最初から選択"]`}
              ...
              <div className="src-grid">
                <div className="src">
                  ...
                  <div className="src-t">
                    Lipton RB, et al. Stratified care vs step care strategies for migraine: the DISC
                    study. JAMA. 2000;284(20):2599-2605.
                  </div>
            ...
            <section id="s3" className="sec">
              ...
              <p>
                急性期治療のもう一つの重要な原則が「<strong>早期に治療する</strong>
                」という考え方です。
              ...
              <p>
                ...
                この中枢性感作が臨床的に現れたものが「
                <strong>皮膚アロディニア（cutaneous allodynia）</strong>」、
                すなわち本来は痛みを伴わない刺激（髪をとかす、眼鏡をかけるなど）を痛みとして感じる状態です。
                Rami
                Bursteinらの基礎的知見によれば、いったんアロディニアが成立した段階でトリプタンを投与しても、
              ...
              <div className="phase-grid">
                ...
                <div className="ph ph3">
                  ...
                  <div className="ph-desc">
                    皮膚アロディニアが出現しうる。治療反応性が低下しうるとされる段階
                  </div>
                </div>
              ...
              <div className="alert a-purple">
                ...
                <div>
                  ...
                  <strong>
                    個々の患者にとって「どの段階で」「何を」服薬すべきかは、医師との相談のうえで決めるべき事項
                  </strong>
                  です。 <span className="bU">U</span>
                </div>
              </div>
  ...
  D -.->|治療機会の窓が狭まる段階| G["トリプタン等の効果が減弱しうるとされる"]`}
                ...
                <table>
                  ...
                  <tbody>
                    <tr>
                      <td>2時間後の疼痛消失</td>
                      <td>
                        治療開始から2時間後に頭痛が完全に消失しているか（pain-free at 2 hours）
                      </td>
                    </tr>
                    <tr>
                      <td>2時間後の疼痛改善</td>
                      <td>
                        中等度〜重度の痛みが軽度以下に軽減しているか（pain relief at 2 hours）
                      </td>
                    </tr>
                    <tr>
                      <td>24時間以内の再発の有無</td>
              ...
              <div className="src-grid">
                <div className="src">
                  <div className="src-org">Primary Source</div>
                  <div className="src-t">
                    Lantéri-Minet M, et al. Early dosing and efficacy of triptans in acute migraine
                    treatment: the TEMPO study. Cephalalgia. 2012.
                  </div>
                  <div className="src-url">
                ...
                <div className="src">
                  <div className="src-org">Secondary Source</div>
                  <div className="src-t">
                    Burstein R, et al. Migraine headaches and allodynia: early use of triptans to
                    improve outcome (Medscape解説)
                  </div>
                  <div className="src-url">
            ...
            <section id="s4" className="sec">
              ...
              <div className="drug-grid">
                <div className="drug">
                  ...
                  <div className="drug-tx">
                    非オピオイド系の鎮痛薬。血管収縮作用なし。禁忌・不耐容例での選択肢。
                  </div>
                </div>
                <div className="drug">
                ...
                <div className="drug">
                  ...
                  <div className="drug-tx">
                    5-HT1B/1D受容体作動薬。血管収縮作用あり。片頭痛特異的治療の中心。
                  </div>
                </div>
                <div className="drug">
              ...
              <div className="src-grid">
                <div className="src">
                  ...
                  <div className="src-t">
                    Derry S, Moore RA. Paracetamol (acetaminophen) with or without an antiemetic for
                ...
                <div className="src">
                  <div className="src-org">Cochrane Systematic Review</div>
                  <div className="src-t">
                    Richer L, et al. Drugs for the acute treatment of migraine in children and
                    adolescents.
                  </div>
                  <div className="src-url">
              ...
              <p>
                ...
                アスピリン（900〜1000mg相当 of 単回投与を検討した別のCochraneレビュー、Kirthi V, et
                al., 2013年）についても、 イブプロフェン400mgと同程度の有効性が報告されています。{" "}
              ...
              <div className="src-grid">
                <div className="src">
                  <div className="src-org">Cochrane Systematic Review</div>
                  <div className="src-t">
                    Rabbie R, Derry S, Moore RA. Ibuprofen with or without an antiemetic for acute
                ...
                <div className="src">
                  ...
                  <div className="src-t">
                    日本頭痛学会「頭痛の診療ガイドライン2021」概要（ケアネット）
                  </div>
                  <div className="src-url">
              ...
              <p>
                ...
                片頭痛に特異的な急性期治療薬（migraine-specific
                agent）として国際的に第一選択薬の一つに位置づけられています。
                ...
                <table>
                  ...
                  <tbody>
                    <tr>
                      <td>①頭蓋血管の収縮</td>
                      <td>
                        血管平滑筋上の5-HT1B受容体を刺激することにより、片頭痛発作時に拡張した頭蓋外硬膜血管を収縮させる
                      </td>
                    </tr>
                    <tr>
                      <td>②末梢神経終末でのペプチド放出抑制</td>
                      <td>
                        三叉神経終末上の5-HT1D受容体を刺激し、CGRP・サブスタンスPなどの神経ペプチド遊離を抑制する
                      </td>
                    </tr>
                    <tr>
                      <td>③中枢における痛覚伝達の抑制</td>
              ...
              <div className="alert a-danger">
                ...
                <div>
                  ...
                  脳幹性前兆を伴う片頭痛などでは、一般に使用が推奨されない、あるいは禁忌とされています（日本頭痛学会ガイドライン2021,
                  CQ II-2-3付帯事項）。 個々の適否は必ず医師が判断します。
                </div>
              </div>
              <p>
                米国頭痛学会（AHS）の2021年コンセンサス声明では、トリプタンの処方を受けた患者のうち約30％が効果不十分（insufficient
                response）
              ...
              <div className="src-grid">
                ...
                <div className="src">
                  ...
                  <div className="src-t">
                    Ailani J, et al. The American Headache Society Consensus Statement 2021.
                    Headache.
                  </div>
                  <div className="src-url">
              ...
              <p>
                ...
                トリプタンとは異なり5-HT1B受容体への作用が乏しいため、
                <strong>血管収縮作用を実質的に持たない</strong>
              ...
              <div className="src-grid">
                <div className="src">
                  ...
                  <div className="src-t">
                    Lasmiditan mechanism of action review of a selective 5-HT1F agonist. PMC.
                  </div>
                  <div className="src-url">
              ...
              <div className="alert a-danger">
                <div className="alert-i">🇯🇵</div>
                <div>
                  <strong>国内における承認状況（2026年7月時点）</strong>
                  ：ゲパントは成分ごとに国内承認状況が異なるため、特に注意が必要です。
                  <ul style={{ marginTop: 8 }}>
                    <li>
                      <strong>リメゲパント</strong>
                      ：2025年9月に国内で製造販売承認を取得し、同年12月に発売。
                      国内では急性期治療および発作抑制（予防）の両方の適応を持つ、日本初の経口ゲパント。
                      米国では2020年（急性期）・2021年（予防）、欧州（EMA）では2022年に承認。
                    </li>
                    <li>
                      <strong>アトゲパント</strong>
                      ：国内では2026年4月に発売されているが、これは予防（発症抑制）を目的とした適応であり、
                      急性期治療薬としての位置づけではない。
                    </li>
                    <li>
                      <strong>ウブロゲパント・ザベゲパント（点鼻）</strong>
                      ：本ページ作成時点（2026年7月）で<strong>国内未承認</strong>。
              ...
              <div className="alert a-info">
                ...
                <div>
                  ...
                  ラスミジタン（ジタン）・ウブロゲパント・リメゲパント（ゲパント）を、トリプタンと同じ「Group
                  1（有効）」 に位置づけていますが、これは発行時点での
                  <strong>海外の承認状況・エビデンスに基づく評価</strong>であり、
              ...
              <div className="src-grid">
                <div className="src">
                  ...
                  <div className="src-t">
                    Gepants: targeting the CGRP pathway for migraine relief. Frontiers in
                    Pharmacology, 2025.
                  </div>
                  <div className="src-url">
                ...
                <div className="src">
                  ...
                  <div className="src-t">
                    ファイザー株式会社「ナルティークOD錠75mg発売」プレスリリース（2025年12月16日）
                  </div>
                  <div className="src-url">
                ...
                <div className="src">
                  ...
                  <div className="src-t">
                    日経メディカル「片頭痛発作の急性期治療と発症抑制の両方に有効な経口薬」
                  </div>
                  <div className="src-url">
                ...
                <div className="src">
                  <div className="src-org">国内動向（二次情報）</div>
                  <div className="src-t">
                    日経メディカル「2剤登場したゲパント薬の実力」（2026年4月）
                  </div>
                  <div className="src-url">
            ...
            <section id="s5" className="sec">
                ...
                <table>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <span className="bGrn">承認済み</span>（成分により異なる）
                      </td>
                    </tr>
                    <tr>
                      <td>トリプタン</td>
                    ...
                    <tr>
                      ...
                      <td>
                        <span className="bGrn">承認済み</span>（2022年）
                      </td>
                    </tr>
                    <tr>
                      <td>ゲパント</td>
                      ...
                      <td>
                        リメゲパントのみ急性期適応で<span className="bGrn">承認済み</span>
                        （2025年）。ウブロゲパント・ザベゲパントは
                        <span className="bRed">国内未承認</span>
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <div className="alert a-warn">
                ...
                <div>
                  ...
                  国際的なコンセンサスに基づく<strong>一般的な概念図</strong>
                  です。実際の治療方針は、医師が患者ごとの病歴・併存疾患・禁忌・患者の希望を踏まえて個別に決定します。
                </div>
              </div>
  ...
  J --> K["使用日数を記録しMOHの予防に配慮する"]`}
              ...
              <div className="src-grid">
                <div className="src">
                  ...
                  <div className="src-t">
                    Ailani J, et al. AHS Consensus Statement 2021. Headache.
                  </div>
                  <div className="src-url">
                    <Ext href="https://headachejournal.onlinelibrary.wiley.com/doi/10.1111/head.14153">
                      https://headachejournal.onlinelibrary.wiley.com/doi/10.1111/head.14153
                ...
                <div className="src">
                  ...
                  <div className="src-t">
                    ...
                    pharmacological treatment of migraine. Cephalalgia. 2024.
                  </div>
                  <div className="src-url">
            ...
            <section id="s6" className="sec">
              ...
              <div className="alert a-warn">
                <div className="alert-i">📘</div>
                <div>
                  <strong>本セクションについての注記</strong>
                  ：本セクションはMOHの概念と一般的な予防の考え方を解説するものであり、
              ...
              <p>
                急性期治療は「早期に、必要なときに使う」ことが原則である一方、
                <strong>使いすぎるとかえって頭痛を悪化させる</strong>
                という逆説的な現象が知られています。これが「薬剤の使用過多による頭痛（Medication-Overuse
                Headache; MOH）」です。
              </p>
                ...
                <table>
                  ...
                  <tbody>
                    <tr>
                      <td>A</td>
                      <td>
                        もともと頭痛性疾患を有する患者において、頭痛が月に15日以上出現していること
                      </td>
                    </tr>
                    <tr>
                      <td>B</td>
                      <td>
                        急性期・対症的頭痛治療薬を3か月を超えて定期的に使用過多していること（薬剤クラスにより閾値が異なる。下記参照）
                      </td>
                    </tr>
                    <tr>
                      <td>C</td>
              ...
              <div className="moh-grid">
                <div className="moh moh-h">
                  ...
                  <div className="moh-drug">
                    エルゴタミン・トリプタン・オピオイド・配合鎮痛薬（単一クラス）
                  </div>
                </div>
                <div className="moh moh-m">
                  ...
                  <div className="moh-unit">3か月を超えて定期使用</div>
                  <div className="moh-drug">
                    単純鎮痛薬（アセトアミノフェン単剤、NSAIDs単剤、アスピリン単剤）
                  </div>
                </div>
                <div className="moh moh-h">
                  <div className="moh-day">
                  ...
                  <div className="moh-drug">
                    上記薬剤クラスの複数を併用（単一クラスでは過用に至らない場合）
                  </div>
                </div>
              ...
              <div className="alert a-purple">
                <div className="alert-i">🔬</div>
                <div>
                  この閾値は「これを超えたら必ずMOHになる」という確定的な基準ではなく、
                  <strong>リスクが高まる目安</strong>として理解する必要があります。
              ...
              <ol>
                <li>
                  <strong>患者教育</strong>
                  ：急性期治療薬の使用日数を意識し、頭痛日記などで記録すること。
                </li>
                <li>
                  <strong>適切な予防（発症抑制）療法の導入</strong>
                  ：頭痛の頻度が高い場合は、急性期治療薬への依存を減らすために予防療法の導入を医師と相談すること。
                </li>
                <li>
                  <strong>過用薬剤の中止・減量</strong>
                  ：医師の指導のもとで、過用状態にある薬剤を計画的に中止・減量すること（自己判断での急な中止は推奨されない）。
                </li>
                <li>
                  <strong>フォローアップ</strong>
                  ：中止後の頭痛経過を医師とともに継続的に観察し、再発を防ぐこと。
                </li>
              </ol>
  ...
  D --> H["早期服薬の原則を維持しつつ使用日数を注視する"]`}
              ...
              <div className="src-grid">
                <div className="src">
                  ...
                  <div className="src-t">
                    8.2 Medication-overuse headache, International Headache Society
                  </div>
                  <div className="src-url">
            ...
            <section id="s7" className="sec">
              ...
              <div className="alert a-ok">
                <div className="alert-i">✅</div>
                <div>
                  いずれの内容も、実際の診断・治療方針の決定には
                  <strong>医師・薬剤師への相談が不可欠</strong>です。
              ...
              <div className="src-grid">
                <div className="src">
                  <div className="src-org">ICHD-3</div>
                  <div className="src-t">
                    International Classification of Headache Disorders 3rd edition, IHS — 8.2
              ...
              <div className="src-grid">
                ...
                <div className="src">
                  ...
                  <div className="src-t">
                    ケアネット「『頭痛の診療ガイドライン』8年ぶり改訂、ポイントは」（2021年12月）
                  </div>
                  <div className="src-url">
                    <Ext href="https://www.carenet.com/news/general/carenet/53578">
                      https://www.carenet.com/news/general/carenet/53578
              ...
              <div className="src-grid">
                <div className="src">
                  ...
                  <div className="src-t">
                    Ailani J, et al. The American Headache Society Consensus Statement. Headache.
                    2021.
                  </div>
                  <div className="src-url">
                    <Ext href="https://headachejournal.onlinelibrary.wiley.com/doi/10.1111/head.14153">
                ...
                <div className="src">
                  ...
                  <div className="src-t">
                    Puledda F, et al. IHS global practice recommendations for the acute
                    pharmacological treatment of migraine. Cephalalgia. 2024;44(8).
                  </div>
                  <div className="src-url">
                    <Ext href="https://journals.sagepub.com/doi/10.1177/03331024241252666">
                      https://journals.sagepub.com/doi/10.1177/03331024241252666
                ...
                <div className="src">
                  ...
                  <div className="src-t">
                    Acute Treatment of Migraine: Expert Consensus Statements from the United Arab
                    Emirates（EHF基準を参照）J Headache Pain. 2022;23(1):133
                  </div>
                  <div className="src-url">
              ...
              <div className="src-grid">
                ...
                <div className="src">
                  <div className="src-org">一次文献</div>
                  <div className="src-t">
                    Lantéri-Minet M, et al. Early dosing and efficacy of triptans: the TEMPO study.
                    Cephalalgia. 2012.
                  </div>
                  <div className="src-url">
                    <Ext href="https://journals.sagepub.com/doi/10.1177/0333102411433042">
              ...
              <div className="src-grid">
                ...
                <div className="src">
                  <div className="src-org">二次情報</div>
                  <div className="src-t">
                    日経メディカル「片頭痛発作の急性期治療と発症抑制の両方に有効な経口薬」（2025年10月）
                  </div>
                  <div className="src-url">
                    <Ext href="https://medical.nikkeibp.co.jp/leaf/all/series/drug/update/202510/590577.html">
                      https://medical.nikkeibp.co.jp/leaf/all/series/drug/update/202510/590577.html
                ...
                <div className="src">
                  <div className="src-org">二次情報</div>
                  <div className="src-t">
                    日経メディカル「2剤登場したゲパント薬の実力は」（2026年4月）
                  </div>
                  <div className="src-url">
                    <Ext href="https://medical.nikkeibp.co.jp/leaf/mem/pub/report/202604/592858.html">
                      https://medical.nikkeibp.co.jp/leaf/mem/pub/report/202604/592858.html
                ...
                <div className="src">
                  <div className="src-org">二次情報</div>
                  <div className="src-t">
                    新薬情報オンライン「レイボー（ラスミジタン）の作用機序・トリプタンとの違い」
                  </div>
                  <div className="src-url">
                    <Ext href="https://passmed.co.jp/di/archives/16626">
                      https://passmed.co.jp/di/archives/16626
              ...
              <p>
                ...
                信頼度の高い順に並べており、
                <strong>
                  一次情報（ガイドライン・原著）を優先し、二次情報（要約サイト）は補助
                </strong>
                とします。
              </p>
              <div className="tbl">
                <table>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>国際ガイドライン</td>
                      <td>
                        AHS（米国頭痛学会）／EHF（欧州頭痛連合）／NICE（英）の頭痛関連ガイドライン・consensus
                        statement
                      </td>
                      <td>治療アルゴリズムの国際動向</td>
      ...
      <div className="footer">
        ...
        <br />📅 作成年: 2026 | 次回レビュー推奨:
        ガイドライン改訂時（ICHD-4公表、日本頭痛学会ガイドライン改訂、PMDA新規承認等）
        <br />
        ⚠️
