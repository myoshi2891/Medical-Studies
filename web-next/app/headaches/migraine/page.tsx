...
style Cl fill:#fffde7,stroke:#f9a825,color:#5c3d00`}
            ...
            <section id="s5" className="sec">
              ...
              <div className="alert a-danger">
                ...
                <div>
                  <strong>最重要！</strong>
                  　以下のいずれか1つでも存在する場合、一次性頭痛の治療を開始する
                  <strong>前に</strong>
              ...
              <div className="snoop-grid">
                ...
                <div className="sn">
                  ...
                  <div className="sn-symp">
                    「生涯最悪の頭痛」・雷鳴頭痛（thunderclap headache）
                  </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <u>PA-free 認定品（Petadolex® 等）のみ</u>
                        使用可。未精製品は絶対に不可。定期的 LFT 測定必要
                      </td>
                    </tr>
                    <tr>
                      <td>
                ...
                <table>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <strong>第1選択：アセトアミノフェン</strong>；重症：IV 硫酸マグネシウム
                        1〜2g
                      </td>
                      <td>
