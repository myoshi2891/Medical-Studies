  ...
  return (
    <div className="moh-accent">
      ...
      <div className="disclaimer">
        ...
        を対象としてとしています。すべての内容は資格を持つ医療専門家による臨床適用前のレビューが必要です。個人的な医療アドバイス・診断・処方を提供するものではありません。
      </div>
...
style H fill:#2980b9,color:#fff`}
          ...
          <section id="s18" className="sec">
            ...
            <p style={{ fontSize: 12, color: "var(--g6)", marginTop: 24 }}>
              ...
              の内容に基づき作成されました。最終更新参照基準日：2025年8月（Claude知識カットオフ）。個別臨床判断は必ず専門医との相談の上で行ってください。
            </p>
          </section>
        </main>
      </div>
