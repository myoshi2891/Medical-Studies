          ...
          <section id="s1" className="sec">
            ...
            <div className="alert a-info">
              ...
              <div>
                ...
                <br />
                <em>
                  &quot;Headache caused by a disorder of the cervical spine and its component bony,
...
style CLINIC fill:#1E8449,color:#fff`}
            ...
            <div className="alert a-info">
              ...
              <div>
                出典：Bogduk N.{" "}
                <em>Cervicogenic headache: anatomic basis and pathophysiologic mechanisms.</em> Curr
                Pain Headache Rep 2001 —{" "}
            ...
            <div className="tbl">
              <table>
                ...
                <tbody>
                  <tr>
                    <td>頸部からの誘発性</td>
                    <td>①頸部運動・不良姿勢、②後頸部/後頭部への外圧 により典型頭痛が誘発される</td>
                  </tr>
                  <tr>
                    <td>頸部可動域制限</td>
                    <td>頸部の可動域が制限される</td>
          ...
          <section id="s10" className="sec">
            ...
            <div className="alert a-info">
              ...
              <div>
                ...
                <strong>頸部可動域/FRT</strong> を併用することで頸部機能の改善を客観的に追跡できる。
              </div>
            </div>
          </section>
...
style BLOCK fill:#8e44ad,color:#fff`}
              ...
              <table>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>上位頸椎モビライゼーション・マニピュレーション、関節モビライゼーション</td>
                    <td>
          ...
          <section id="s16" className="sec">
            ...
            <p>
              ...
              （IHS/ICHD-3、NICE、AAN、Cochrane、PubMed収載の査読論文）に基づきます。以下に出典 URL
              を補足として明示します。
            </p>
