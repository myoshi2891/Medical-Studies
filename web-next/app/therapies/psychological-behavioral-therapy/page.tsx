                ...
                <table>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        カフェイン：就寝6時間前以降を避ける；アルコール：就寝前3時間以内は回避
                      </td>
                    </tr>
                    <tr>
                      <td>
...
style MAINT fill:#27ae60,color:#fff`}
              ...
              <h3>
                STEP9 環境・ライフスタイル調整{" "}
                <span className="bC">Expert Consensus / Grade C</span>
              </h3>
              <div className="tbl">
                <table>
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        モニター高さの調整（視線と水平 or
                        やや下方）；頸部への負荷を最小化；デスク作業 45〜60分毎の5分休憩
                      </td>
                    </tr>
                    <tr>
                      <td>
            ...
            <section id="s13" className="sec">
              ...
              <div className="alert a-purple">
                ...
                <div>
                  ...
                  ACT。すべての介入は SNOOP4 と MOH リスク評価の後に開始し、3ヶ月時点の HIT-6 /
                  MIDAS 再評価で効果を確認する。
                </div>
              </div>
            </section>
            ...
            <section id="s14" className="sec">
              ...
              <div className="src-grid">
                ...
                <div className="src">
                  ...
                  <div className="src-t">
                    Andrasik F. — CBT と薬物療法の長期有効性比較（片頭痛）
                  </div>
