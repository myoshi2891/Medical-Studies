        ...
        <main className="main">
          <AutoGlossary>
            ...
            <section id="s4" className="sec">
              ...
              <p>
                これらの経穴が近接する筋肉は、筋膜性トリガーポイント研究の対象筋肉と重なります。
              </p>
                ...
                <table>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        延髄・椎骨動脈に近接するため、有資格者による適切な解剖学的知識が不可欠
                      </td>
                    </tr>
                    <tr>
                      <td>膏肓は頭痛の特効穴である</td>
            ...
            <section id="s9" className="sec">
              ...
              <div className="src-grid">
                ...
                <div className="src">
                  ...
                  <div className="src-t">
                    Birch S. Trigger point-acupuncture point correlations revisited.
                    2003;9(1):91-103.
                  </div>
                  <div className="src-url">
                ...
                <div className="src">
                  <div className="src-org">Cochrane Library</div>
                  <div className="src-t">
                    Linde K et al. Acupuncture for the prevention of episodic migraine.
                    2016;CD001218.
                  </div>
                  <div className="src-url">
