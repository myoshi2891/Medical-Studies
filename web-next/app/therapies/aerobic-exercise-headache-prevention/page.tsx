              ...
              <div className="card">
                ...
                <ul>
                  <li>
                    ...
                    ）を明記し、「効果がある／ない」という断定ではなく、
                    <strong>相対的な表現</strong>
                    を用いています。
                  </li>
                  <li>
                  ...
                  <table>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          Diagnosis and management of migraine in ten steps（Nature Reviews
                          Neurology, 2021）
                        </td>
                        <td>
                  ...
                  <table>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>継続可能性を重視</td>
                        <td>
                          週2〜3回、1回20分程度からのスタートは、複数の研究プロトコルとも整合的
                        </td>
                      </tr>
                      <tr>
                        <td>⑥数週間ごとの再評価</td>
                  ...
                  <table>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>Step 5</td>
                        <td>
                          新しい症状や頭痛の悪化があれば自己判断で継続せず、速やかに医療機関へ
                        </td>
                      </tr>
                      <tr>
                        <td>Step 6</td>
                  ...
                  <table>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>国際ガイドライン</td>
                        <td>
                          英国 NICE「Headaches in over 12s: diagnosis and management」（CG150）
                        </td>
