                ...
                <table>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        &quot;Feverfew Syndrome&quot;（頭痛反跳・筋硬直・関節痛）→ 漸減すること
                      </td>
                    </tr>
                    <tr>
                      <td>
                ...
                <table>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <strong>
                          血清ビタミンD濃度 &lt; 30 ng/mL（欠乏）の確認後のみ補充を考慮
                        </strong>
                      </td>
                    </tr>
                    <tr>
                ...
                <table>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        B6の頭痛効果のエビデンスは乏しい — 標準食事摂取量（1.3–1.7mg/日）で十分
                      </td>
                    </tr>
                  </tbody>
                </table>
...
style Escalate fill:#c0392b,color:#fff`}
            ...
            <section id="s12" className="sec">
              ...
              <div className="alert a-info">
                <div className="alert-i">📖</div>
                <div>
                  <strong>作成基準</strong>：ICHD-3 | AAN/AHS 2024 | EHF 2022 | IHS 2024 | NICE
