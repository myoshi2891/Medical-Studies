...
const TERMS: GlossaryTerm[] = [
  ...
  // --- 血管・脈管（/anatomy/vascular-headache 系）---
  {
    id: "dura-mater",
    term: "硬膜",
    reading: "こうまく",
    plain:
      "脳を包む 3 枚の膜のうち一番外側の丈夫な膜。痛みを感じる神経が通っており、頭痛の発生源になります。",
  },
  {
    id: "venous-sinus",
    term: "静脈洞",
    reading: "じょうみゃくどう",
    plain: "硬膜のすき間にできた、脳からの血液を集めて心臓へ返す太い通り道。",
  },
  {
    id: "internal-carotid-artery",
    term: "内頸動脈",
    reading: "ないけいどうみゃく",
    plain: "首の前側を通って脳の前 2/3 へ血液を送る太い動脈。",
  },
  {
    id: "basilar-artery",
    term: "脳底動脈",
    reading: "のうていどうみゃく",
    plain: "左右の椎骨動脈が合流してできる血管。脳幹や小脳へ血液を送ります。",
  },
  {
    id: "sah",
    term: "くも膜下出血",
    reading: "くもまくかしゅっけつ",
    plain: "脳を包む膜のすき間に血がひろがる病気。突然の激しい頭痛が特徴で、すぐの受診が必要です。",
  },
  {
    id: "arterial-dissection",
    term: "動脈解離",
    reading: "どうみゃくかいり",
    plain: "血管の壁が裂けて層の間に血が入り込む状態。首や後頭部の痛みで気づかれることがあります。",
  },
  {
    id: "vasospasm",
    term: "血管攣縮",
    reading: "けっかんれんしゅく",
    plain: "血管が一時的に強く縮んで細くなること。血のめぐりが悪くなります。",
  },
  {
    id: "giant-cell-arteritis",
    term: "巨細胞性動脈炎",
    reading: "きょさいぼうせいどうみゃくえん",
    plain:
      "こめかみなどの動脈に炎症が起きる病気。主に 50 歳以上に起こり、放置すると視力に関わります。",
  },
  {
    id: "rcvs",
    term: "可逆性脳血管攣縮症候群",
    reading: "かぎゃくせいのうけっかんれんしゅくしょうこうぐん",
    plain:
      "脳の血管が一時的に縮み、雷に打たれたような激しい頭痛をくり返す状態。多くは数週間で戻ります。",
  },
  // --- 病態・神経生理（追加）---
  {
    id: "nociceptor",
    term: "侵害受容器",
    reading: "しんがいじゅようき",
    plain: "体に害のある刺激をとらえて「痛み」の信号を出すセンサー。脳そのものにはありません。",
  },
  {
    id: "neurogenic-inflammation",
    term: "神経原性炎症",
    reading: "しんけいげんせいえんしょう",
    plain: "神経の先から出た物質が血管をひろげ、まわりを腫れさせる炎症。片頭痛の痛みに関わります。",
  },
  {
    id: "autonomic-nervous-system",
    term: "自律神経",
    reading: "じりつしんけい",
    plain: "心拍・体温・消化などを自分の意思とは関係なく調節している神経のしくみ。",
  },
  {
    id: "sympathetic-nerve",
    term: "交感神経",
    reading: "こうかんしんけい",
    plain: "体を活動モードにする自律神経。血管を縮め、心拍を上げます。",
  },
  {
    id: "parasympathetic-nerve",
    term: "副交感神経",
    reading: "ふくこうかんしんけい",
    plain: "体を休息モードにする自律神経。涙や鼻水を増やし、群発頭痛の症状にも関わります。",
  },
  {
    id: "hypothalamus",
    term: "視床下部",
    reading: "ししょうかぶ",
    plain: "脳の奥にある、体内時計・食欲・自律神経の司令塔。片頭痛の前ぶれに関わるとされます。",
  },
  {
    id: "brainstem",
    term: "脳幹",
    reading: "のうかん",
    plain: "大脳と脊髄をつなぐ幹の部分。呼吸や意識を保ち、痛みの信号の中継所にもなります。",
  },
  {
    id: "cerebral-cortex",
    term: "大脳皮質",
    reading: "だいのうひしつ",
    plain: "大脳の表面をおおう神経細胞の層。見る・考えるなどの働きを担います。",
  },
  {
    id: "trigeminal-ganglion",
    term: "三叉神経節",
    reading: "さんさしんけいせつ",
    plain: "三叉神経の細胞体が集まった中継地点。頭の中の痛み信号がここを通ります。",
  },
  {
    id: "occipital-neuralgia",
    term: "後頭神経痛",
    reading: "こうとうしんけいつう",
    plain: "後頭部の神経が刺激され、ピリッと電気が走るような痛みが出る状態。",
  },
  // --- 骨・関節（追加）---
  {
    id: "craniocervical-junction",
    term: "頭蓋頸椎移行部",
    reading: "とうがいけいついいこうぶ",
    plain: "頭の骨と首の骨がつながる「継ぎ目」の部分。ここの異常は頭痛の原因になります。",
  },
  {
    id: "atlanto-occipital-joint",
    term: "環椎後頭関節",
    reading: "かんついこうとうかんせつ",
    plain: "頭蓋骨と一番上の首の骨をつなぐ関節。うなずく動きを担当します。",
  },
  {
    id: "paranasal-sinus",
    term: "副鼻腔",
    reading: "ふくびくう",
    plain: "鼻のまわりの骨の中にある空洞。炎症が起きると顔や額の痛みが出ます。",
  },
  {
    id: "tmj",
    term: "顎関節",
    reading: "がくかんせつ",
    plain: "耳の前にある、あごを開け閉めする関節。不調はこめかみの痛みにつながります。",
  },
  {
    id: "temporal-bone",
    term: "側頭骨",
    reading: "そくとうこつ",
    plain: "こめかみから耳のまわりを構成する骨。耳の器官や顎関節が収まっています。",
  },
  {
    id: "sphenoid-bone",
    term: "蝶形骨",
    reading: "ちょうけいこつ",
    plain: "頭蓋骨の中央にある蝶のような形の骨。多くの神経や血管の通り道になっています。",
  },
  // --- 筋（追加）---
  {
    id: "temporalis",
    term: "側頭筋",
    reading: "そくとうきん",
    plain: "こめかみにある、あごを閉じる筋肉。こると締めつけるような頭痛につながります。",
  },
  {
    id: "masseter",
    term: "咬筋",
    reading: "こうきん",
    plain: "えらの部分にある、かむための強い筋肉。食いしばりで硬くなります。",
  },
  {
    id: "frontalis",
    term: "前頭筋",
    reading: "ぜんとうきん",
    plain: "おでこにあって眉を上げる筋肉。緊張型頭痛で圧痛が出やすい場所です。",
  },
  {
    id: "splenius",
    term: "板状筋",
    reading: "ばんじょうきん",
    plain: "首の後ろにある板のような筋肉。頭を反らせたり回したりします。",
  },
  {
    id: "levator-scapulae",
    term: "肩甲挙筋",
    reading: "けんこうきょきん",
    plain: "首の横から肩甲骨につく筋肉。肩をすくめる動きを担い、肩こりの主役のひとつです。",
  },
  {
    id: "scalene",
    term: "斜角筋",
    reading: "しゃかくきん",
    plain: "首の横にある、肋骨を引き上げて呼吸を助ける筋肉。",
  },
  // --- 臨床所見 ---
  {
    id: "tenderness",
    term: "圧痛",
    reading: "あっつう",
    plain: "指で押したときに感じる痛み。筋肉のこりや炎症のある場所をみつける手がかりです。",
  },
  {
    id: "range-of-motion",
    term: "可動域",
    reading: "かどういき",
    plain: "関節を動かせる範囲のこと。首の可動域が狭いと頸原性頭痛が疑われます。",
  },
  // --- 治療方針・薬剤（追加）---
  {
    id: "acute-treatment",
    term: "急性期治療",
    reading: "きゅうせいきちりょう",
    plain: "頭痛が起きたときに、その痛みを止めるために行う治療。",
  },
  {
    id: "preventive-treatment",
    term: "予防療法",
    reading: "よぼうりょうほう",
    plain: "発作の回数や強さを減らすために、痛みがないときも続ける治療。",
  },
  {
    id: "ergotamine",
    term: "エルゴタミン",
    reading: "えるごたみん",
    plain: "血管を縮めて片頭痛をおさえる古くからの薬。使いすぎに注意が必要です。",
  },
  {
    id: "beta-blocker",
    term: "β遮断薬",
    reading: "べーたしゃだんやく",
    plain: "心臓や血管への刺激をやわらげる薬。片頭痛の予防にも使われます。",
  },
  {
    id: "antidepressant",
    term: "抗うつ薬",
    reading: "こううつやく",
    plain: "気分を整える薬。痛みを伝える神経のはたらきも調整するため、頭痛の予防に使われます。",
  },
  {
    id: "antiepileptic",
    term: "抗てんかん薬",
    reading: "こうてんかんやく",
    plain: "神経の興奮をしずめる薬。片頭痛の予防にも用いられます。",
  },
  {
    id: "antiemetic",
    term: "制吐薬",
    reading: "せいとやく",
    plain: "吐き気や嘔吐をおさえる薬。片頭痛発作のつらさをやわらげます。",
  },
  {
    id: "prostaglandin",
    term: "プロスタグランジン",
    reading: "ぷろすたぐらんじん",
    plain: "体の中で炎症や痛みを強める物質。NSAIDs はこの生成をおさえて効きます。",
  },
  {
    id: "nitric-oxide",
    term: "一酸化窒素",
    reading: "いっさんかちっそ",
    plain: "血管をひろげる働きを持つ気体状の物質。片頭痛の引き金のひとつとされます。",
  },
  {
    id: "withdrawal-headache",
    term: "離脱頭痛",
    reading: "りだつずつう",
    plain: "使いすぎていた薬をやめたときに、一時的に強くなる頭痛。数日〜2 週間ほどで落ち着きます。",
  },
  {
    id: "cbt-ja",
    term: "認知行動療法",
    reading: "にんちこうどうりょうほう",
    plain: "考え方や行動のくせを見直して、痛みやストレスへの向き合い方を変えていく心理療法。",
  },
  {
    id: "adherence",
    term: "アドヒアランス",
    reading: "あどひあらんす",
    plain: "決めた治療や服薬を、患者さん自身が納得して続けられている度合い。",
  },
  {
    id: "menstrual-migraine",
    term: "月経関連片頭痛",
    reading: "げっけいかんれんへんずつう",
    plain: "生理の前後に起こりやすい片頭痛。女性ホルモンの急な変化が関わります。",
  },
  // --- 生活習慣 ---
  {
    id: "circadian-rhythm",
    term: "概日リズム",
    reading: "がいじつりずむ",
    plain: "約 24 時間の周期でくり返す体内時計のリズム。睡眠や体温を調節しています。",
  },
  {
    id: "sleep-hygiene",
    term: "睡眠衛生",
    reading: "すいみんえいせい",
    plain: "寝る時間や寝室の環境など、よく眠るために整えるべき生活習慣のこと。",
  },
  {
    id: "sleep-apnea",
    term: "睡眠時無呼吸",
    reading: "すいみんじむこきゅう",
    plain: "眠っている間に呼吸が何度も止まる状態。起床時の頭痛の原因になります。",
  },
  {
    id: "caffeine",
    term: "カフェイン",
    reading: "かふぇいん",
    plain: "コーヒーやお茶に含まれる成分。とりすぎや急な中断が頭痛の引き金になります。",
  },
  {
    id: "alcohol",
    term: "アルコール",
    reading: "あるこーる",
    plain: "お酒に含まれる成分。血管をひろげ脱水も招くため、頭痛の引き金になりやすいです。",
  },
  {
    id: "dehydration",
    term: "脱水",
    reading: "だっすい",
    plain: "体の水分が足りなくなった状態。それ自体が頭痛を起こすことがあります。",
  },
  {
    id: "trigger-factor",
    term: "誘因",
    reading: "ゆういん",
    plain: "頭痛の発作を引き起こすきっかけ。天候・空腹・寝不足・においなど人によって違います。",
  },
  {
    id: "self-care",
    term: "セルフケア",
    reading: "せるふけあ",
    plain: "自分で行う体調管理の工夫。記録・休息・運動・環境調整などが含まれます。",
  },
  // --- EBM・研究デザイン ---
  {
    id: "meta-analysis",
    term: "メタ解析",
    reading: "めたかいせき",
    plain: "同じテーマの複数の研究結果をまとめて統計的に分析する方法。信頼度の高い根拠になります。",
  },
  {
    id: "systematic-review",
    term: "システマティックレビュー",
    reading: "しすてまてぃっくれびゅー",
    plain: "決めた手順で研究を漏れなく集めて評価する総説。エビデンスの中でも信頼度が高い方法です。",
  },
  {
    id: "rct",
    term: "ランダム化比較試験",
    reading: "らんだむかひかくしけん",
    plain: "参加者をくじ引きのように振り分けて治療を比べる研究。思い込みの影響を減らせます。",
  },
  {
    id: "placebo",
    term: "プラセボ",
    reading: "ぷらせぼ",
    plain: "有効成分の入っていない偽薬。本物の薬と比べて効果を確かめるために使われます。",
  },
  {
    id: "confidence-interval",
    term: "信頼区間",
    reading: "しんらいくかん",
    plain: "研究で得られた値が、どのくらいの幅に収まりそうかを示す範囲。狭いほど確からしいです。",
  },
  {
    id: "evidence-level",
    term: "エビデンスレベル",
    reading: "えびでんすれべる",
    plain: "その根拠がどれくらい信頼できるかを段階で示したもの。研究の方法によって決まります。",
  },
  {
    id: "cochrane",
    term: "コクラン",
    reading: "こくらん",
    plain: "医療の根拠を厳密にまとめて公開している国際的な非営利団体（Cochrane）。",
  },
  // --- 臨床・社会 ---
  {
    ...
    term: "問診",
    reading: "もんしん",
    plain: "症状の起こり方や経過を医師が聞き取ること。頭痛の診断で最も重要な手がかりです。",
  },
  {
    id: "imaging-study",
    term: "画像検査",
    reading: "がぞうけんさ",
    plain: "CT や MRI で体の中を撮影する検査。危険な二次性頭痛の除外に使われます。",
  },
  {
    id: "reasonable-accommodation",
    term: "合理的配慮",
    reading: "ごうりてきはいりょ",
    plain: "困りごとがある人が働き学べるよう、職場や学校が負担の重すぎない範囲で行う調整。",
  },
  {
    id: "occupational-physician",
    term: "産業医",
    reading: "さんぎょうい",
    plain: "働く人の健康を守るために職場に関わる医師。就業上の配慮について相談できます。",
  },
  // --- 連携・認証システム ---
  {
    id: "access-token",
