...
```mermaid
flowchart TD
    A["🔴 急性期頭痛薬の慢性過用<br/>（>8〜10日/月 × 3ヶ月以上）"]
    A --> B["三叉神経痛覚経路の持続的活性化"]
...
|---|---|---|---|---|
| **オピオイド** | コデイン、トラマドール、モルヒネ | **≥8日/月** | 🔴 最高 | 🔴 高（漸減必須） |
| **複合鎮痛薬** | カフェイン配合、バルビツール配合製剤 | **≥8日/月** | 🔴 高 | 🔴 高（漸減推奨） |
| **エルゴタミン** | エルゴタミン酒石酸塩 | **≥8日/月** | 🔴 高 | 🟠 中〜高 |
| **トリプタン** | スマトリプタン、ゾルミトリプタン等 | **≥8日/月** | 🟠 中〜高 | 🟡 中（比較的迅速） |
| **アセトアミノフェン** | パラセタモール（カロナール等） | **≥10日/月** | 🟡 中 | 🟡 中 |
| **NSAIDs（アスピリン含む）** | イブプロフェン、ナプロキセン等 | **≥10日/月** | 🟡 中 | 🟡 中 |
...
flowchart TD
    ...
    DRUG_CHECK["📋 薬剤別閾値チェック<br/>━━━━━━━━━━━━━━━━━━<br/>✦ トリプタン・オピオイド・エルゴタミン<br/>  → ≥8日/月 × &gt;3ヶ月<br/>✦ 鎮痛薬（アセトアミノフェン・NSAIDs）<br/>  → ≥10日/月 × &gt;3ヶ月<br/>✦ 複合鎮痛薬<br/>  → ≥8日/月 × &gt;3ヶ月"]
...
| 月間急性期薬使用日数 | **<10日/月**（NSAID/アセトアミノフェン）または**<8日/月**（トリプタン） |
