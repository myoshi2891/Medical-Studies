...
flowchart TD
    ...
    TYPE{"ICHD-3 頻度分類"}
    TYPE -->|"< 1 日/月\nICHD-3: 2.1"| INFREQ["非頻発性 TTH\nセルフケア主体で十分"]
    TYPE -->|"1–14 日/月\nICHD-3: 2.2"| FREQ["頻発性 TTH\n積極的 PT 介入"]
    TYPE -->|"≥ 15 日/月\nICHD-3: 2.3"| CHRONIC["慢性 TTH\n包括的マルチモーダル介入"]
...
flowchart TD
    ...
    PSYCH --> PS2["マインドフルネス Grade C"]
    PSYCH --> PS3["ストレス管理 Grade B"]

    NUTR --> N1["マグネシウム 400–600 mg/日\nGrade A（AAN/EHF 推奨）"]
    NUTR --> N2["リボフラビン（B2）400 mg/日\nGrade B"]
    NUTR --> N3["CoQ10（ユビキノール）300 mg/日\nGrade B"]

    LIFE --> L1["睡眠衛生\n7–8 時間 / 規則的なスケジュール"]
    LIFE --> L2["水分補給\n1.5–2L / 日以上"]
    LIFE --> L3["食事トリガー管理\n標準化された食事日誌の使用"]

    PT1 & PS3 & N1 & L1 --> SYNERGY["✨ 相乗効果\nSynergistic Effect\n単剤アプローチより優れた転帰\n頭痛頻度 ≥ 50% 減少の達成"]
